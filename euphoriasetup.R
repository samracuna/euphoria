...
# Create the R/ folder and move theme_euphoria.R into it
dir.create("R")
file.copy("theme_euphoria.R", "R/theme_euphoria.R")
file.remove("theme_euphoria.R")

list.files("R/")
# should print: "theme_euphoria.R"

devtools::document()   # regenerates NAMESPACE with the export
devtools::install()    # reinstalls with the updated NAMESPACE
devtools::build_readme()
# ------------------------------------------------------------
# 8. Initialise git
# ------------------------------------------------------------
